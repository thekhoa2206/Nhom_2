...
import { useCheckOut, useGetAllRooms } from '../../services/rooms/room.service';
                                            ...
                                            <Grid item xs={10}>
                                                <Grid container>
                                                    ...
                                                    <Grid item xs={5}>
                                                        ...
                                                        <Typography textAlign="right" fontWeight="bold">{numberWithCommas(roomPrice + serviceTotal - deposit + additionalFee - reducedFee)}đ</Typography>
                                                    </Grid>
                                                </Grid>
