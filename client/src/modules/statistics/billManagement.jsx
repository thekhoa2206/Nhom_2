...
function BillManagement(props) {
    ...
    const columns = [
        ...
        {
            field: 'guests', headerName: 'Khách hàng', align: "center", width: 180, headerAlign: 'center',
            valueGetter: (params) =>
                `${(params.row.guests[0].firstName)}` + " " + `${(params.row.guests[0].lastName)}`,
        },
        { field: 'roomName', type: 'text', headerName: 'Tên phòng', align: "center", headerAlign: 'center', width: 150, },
        {
            field: 'checkInTime', headerName: 'Giờ vào', headerAlign: 'center', align: "center", width: 150, valueGetter: (params) =>
                `${(dayjs(params.row.checkInTime).format('HH:mm DD/MM/YYYY'))}`
        },
        {
            field: 'checkOutTime', headerName: 'Giờ ra', headerAlign: 'center', align: "center", width: 200, valueGetter: (params) =>
                `${(dayjs(params.row.checkOutTime).format('HH:mm DD/MM/YYYY'))}`
        },
        {
            field: 'totalPrice', headerName: 'Thanh toán', width: 180, valueGetter: (params) =>
