...
INSERT INTO `bill` VALUES (1,1,0.00,0.00,'',0,500000.00);
...
CREATE TABLE `guest` (
  ...
  `id_card` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `status` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `occupied_room` (
  ...
  `check_out_time` bigint(20) DEFAULT NULL,
  `status` int(11) DEFAULT NULL,
  ...
  CONSTRAINT `fk_occupied_room_bill_id` FOREIGN KEY (`bill_id`) REFERENCES `bill` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `room` VALUES (1,'101',1,1),(2,'102',2,1);
...
INSERT INTO `room_price` VALUES (1,1,1,1000000.00),(2,1,2,500000.00);
...
INSERT INTO `service` VALUES (1,'Giat la','',1,50000.00),(2,'Xe Đưa Đón','',1,200000.00);
...
CREATE TABLE `status` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `status_name` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
  `table_name` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-12-10 18:03:14
